...
public class Feat implements ICommand {
    private final String name = "feat";
    private final String description = "Look up a feat by name.";
    ...
    public List<OptionData> getOptions() {
        ...
        optionData.add(new OptionData(OptionType.STRING, "lookup",
                "The feat you would like to lookup", true, true));
        return optionData;
    }
